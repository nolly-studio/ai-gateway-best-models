...
export const SITE_TITLE = "Best AI Gateway models today"
export const SITE_TITLE_TEMPLATE = `%s · ${SITE_NAME}`
export const SITE_DESCRIPTION =
  "Daily picks for the best Vercel AI Gateway models, ranked from the live catalog, the last complete export day versus the 7-day mean, and DeepsecBench. This week's ranking lives at /week. ZDR is a route badge, not a separate list."
export const WEEK_TITLE = "Best AI Gateway models this week"
export const WEEK_DESCRIPTION =
