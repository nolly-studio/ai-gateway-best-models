...
- https://www.bestmodels.dev/data/gateway.json
- https://www.bestmodels.dev/data/history.json
- https://www.bestmodels.dev/llms.txt (generated from the current snapshot)
